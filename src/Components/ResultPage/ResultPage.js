import { changeBtnTxt, chnageIcon } from "./Result_page";
...
const ResultPage = () => {
  return (
    <>
      <Header />
      <div className="container result_page_container">
        <div
            ...
            <div className="collapse navbar-collapse" id="mynav">
              <ul className="navbar-nav d-lg-flex align-items-lg-center">
                <li className="nav-item active">
                  <select defaultValue={"None"} name="sort" id="sort">
          ...
          <div id="filterbar" className="collapse">
            <div className="box border-bottom">
              <div className="form-group text-center">
                <div
                  className="btn-group group_btn_custom"
                  data-toggle="buttons"
                >
            ...
            <div className="box border-bottom">
              ...
              <div id="inner-box" className="collapse mt-2 mr-1">
                <div className="my-1">
                  <label className="tick">
                    Windbreaker <input type="checkbox" defaultChecked={true} />
                    <span className="check"></span>{" "}
                  </label>
                </div>
                <div className="my-1">
                ...
                <div className="my-1">
                  <label className="tick">
                    Handbag <input type="checkbox" defaultChecked={true} />
                    <span className="check"></span>{" "}
                  </label>
                </div>
                <div className="my-1">
                ...
                <div className="my-1">
                  <label className="tick">
                    Wallets <input type="checkbox" defaultChecked={true} />
                    <span className="check"></span>{" "}
                  </label>
                </div>
              </div>
            ...
            <div className="box border-bottom">
              ...
              <div id="inner-box2" className="collapse mt-2 mr-1">
                <div className="my-1">
                  <label className="tick">
                    Spring <input type="checkbox" defaultChecked={true} />{" "}
                    <span className="check"></span>{" "}
                  </label>
                </div>
                <div className="my-1">
                ...
                <div className="my-1">
                  <label className="tick">
                    Autumn <input type="checkbox" defaultChecked={true} />
                    <span className="check"></span>{" "}
                  </label>
                </div>
                <div className="my-1">
          ...
          <div id="products">
            <div className="row mx-0">
              ...
              <div className="col-lg-4 col-md-6 pt-md-0 pt-3">
                <div className="card d-flex flex-column align-items-center">
                  <div className="product-name">Nike T shirts for Men</div>
                  <div className="card-img">
                    <img
